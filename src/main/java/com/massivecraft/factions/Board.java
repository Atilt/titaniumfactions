...
public abstract class Board {
    ...
    public abstract Faction clearOwnershipAt(FLocation flocation);
     ...
     * of decreasing z
     */
    public abstract List<TextComponent> getMap(FPlayer fPlayer, FLocation flocation, double degrees);
